    ...
    return (
        <>
            ...
            <div className="w-dvw px-14 grid grid-cols-3 py-4">
                ...
                <div className={`flex flex-col justify-center items-center transition-opacity duration-300 ease-out ${isDrawerOpen && 'opacity-0'}`}>
                    {isLoading
            ...
            <div className="w-dvw relative"
                ...
                <div className="absolute px-14 h-full left-0 top-0 flex flex-col gap-2">
                ...
                <div className="max-w-5xl mx-auto h-full bg-stone-50/85 rounded-t-4xl shadow-box overflow-clip">
                    <div className={`mx-auto px-8 bg-stone-200 w-full overflow-hidden duration-300 transition-all ease-out relative ${isDrawerOpen ? 'max-h-full py-8 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                        {/* settings drawer */}
                        {currentNote && <>
                            <div>
                    ...
                    <div className="mx-auto w-full px-8 pt-4 pb-8 flex flex-row-reverse justify-between items-baseline gap-2">
                        {/* top bar */}
                                ...
                                {currentNote.blocks.map((block, idx) => (
                                    <div key={block.id} className="mb-2">
                                        ...
                                        {block.type === 'paragraph' && <div
                                            ...
                                            <span
                                                aria-hidden="true"
                                                className="pointer-events-none invisible whitespace-pre-wrap py-1 col-start-1 row-start-1"
                                            >
                                                {(block.content || "") + " "}
                                            </span>
                                            <textarea
                                                className="w-full outline-0 focus:bg-stone-200 text-stone-700 placeholder:text-stone-500 py-1 resize-none col-start-1 row-start-1"
                                                value={block.content}
                                                rows={1}
                                                onChange={e => {
                                                    setCurrentNote(prev => ({
